...
export const CONFIG_GROUPS: ConfigGroupMeta[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: "readers.asr.engine", label: "ASR engine", widget: "select" },
      ...
      { path: "readers.asr.dual.asr", label: "Dual: ASR backends", widget: "select" },
      { path: "readers.asr.dual.diarize", label: "Dual: speaker diarization", widget: "boolean" },
      { path: "readers.asr.dual.numSpeakers", label: "Dual: speaker count hint", widget: "number", placeholder: "(auto)" },
      { path: "readers.asr.dual.projectDir", label: "Dual: Python project dir", widget: "text" },
      { path: "readers.pdfEngine", label: "PDF engine", widget: "select" },
      { path: "readers.marker.useLlm", label: "Marker: --use_llm (better tables)", widget: "boolean" },
      { path: "readers.mistral.model", label: "Mistral OCR model", widget: "text" },
